...
<div id="container">
	...
	<div id="content">
		...
		<div id="weekly">	  
		<h1> More on Servers</h1>
			<ul><li>PERL &amp; CGI</li>
				<li>Outputting HTML (or whatever)</li>
				<li>Regular Expressions</li>
				<li>Apache configuration</li>
				<li>Server Side Includes &amp; .htaccess</li>
			</ul>
		<h2>Final Project Milestone : site mock-up ready for in-class review - MONDAY</h2>
		<h2>Practice Practical Exam - WEDNESDAY</h2>
